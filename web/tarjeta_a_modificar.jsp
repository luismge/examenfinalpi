<%-- 
    Document   : nueva_tarjeta
    Created on : 02-dic-2015, 13:27:45
    Author     : JuanCarlos
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">AGREGAR TARJETAS:
                    </h1>
                    <ol class="breadcrumb">
            ...
            <div class="row">  
                <form method="POST" action="modificar_tarjeta">
                    <% Tarjeta tarjeta = (Tarjeta) request.getAttribute("tarjeta"); %>
                    <div class="col-lg-6">
                        <p>Nombre:</p>
                        <input type="text" class="form-control" name="nombre" value="<%=tarjeta.getNombre()%>" required=""/>
                        <p>Atención:</p>
                        <input type="text" class="form-control" name="atencion" value="<%=tarjeta.getAtencion() %>" required=""/>
                        <p>Precio:</p>
                        <input type="number" class="form-control" name="precio" value="<%=tarjeta.getPrecio()%>" required=""/>
                        <p>Dulcería:</p>
                        <input type="text" class="form-control" name="dulceria" value="<%=tarjeta.getDulceria()%>" required=""/>
                    </div>
                    <div class="col-lg-6">
                        <p>Cumpleaños:</p>
                        <input type="text" class="form-control" name="cumpleanos" value="<%=tarjeta.getCumpleanos()%>" required=""/>
                        <p>Calendario:</p>
                        <input type="text" class="form-control" name="calendario" value="<%=tarjeta.getCalendario()%>" required=""/>
                        <p>Imagen:</p>
                        <input type="file" name="imagen" required value="<%=tarjeta.getImg()%>" style="width:400px;"/>
                        <br>
                        <input type="submit" class="btn btn-danger" value="Guardar Tarjeta" />
                    </div>
                </form>       
            </div>
