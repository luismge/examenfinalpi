...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">INTENTE INGRESAR OTRO CORREO
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="registro_cliente.jsp">CLIC AQUÍ PARA REGISTRARSE</a>
                        </li>
                        <li class="active" style="color: red; font-size: 18px;">El correo que desea ingresar <span style="font-weight: bolder;">ya existe en nuestra base de datos</span>, por favor ingrese otro.</li>
                    </ol>
                </div>
            </div>
            <!-- /.row -->      
