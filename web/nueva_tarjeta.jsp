...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">  
                <form method="POST" action="registro_tarjeta">
                    <div class="col-lg-6">
                        <p>Nombre:</p>
                        <input type="text" class="form-control" name="nombre" required=""/>
                        <p>Atención:</p>
                        <input type="text" class="form-control" name="atencion" required=""/>
                        <p>Precio:</p>
                        <input type="number" class="form-control" name="precio" required=""/>
                        <p>Dulcería:</p>
                        <input type="text" class="form-control" name="dulceria" required=""/>
                    </div>
                    <div class="col-lg-6">
                        <p>Cumpleaños:</p>
                        <input type="text" class="form-control" name="cumpleanos" required=""/>
                        <p>Calendario:</p>
                        <input type="text" class="form-control" name="calendario" required=""/>
                        <p>Imagen:</p>
                        <input type="file" name="imagen" required  style="width:400px;"/>
                        <br>
                        <input type="submit" class="btn btn-danger" value="Guardar Película" />
                    </div>
                </form>       
            </div>
