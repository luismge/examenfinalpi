...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">INICIO SESIÓN:
                    </h1>
                    <ol class="breadcrumb">
            ...
            <div class="row">  
                <form method="POST" action="validar_logueo">
                    <div class="col-lg-4"></div>
                    <div class="col-lg-4">
                        <p>Correo:</p>
                        <input type="text" class="form-control" name="correo" placeholder="Ingrese su correo por favor"/>
                        <p>contrasena</p>
                        <input type="password" class="form-control" name="contrasena" placeholder="Ingrese su contraseña por favor"/>
                        <br><input type="submit" style="margin-left: 120px;" class="btn btn-success" value="Iniciar Sesión" />
                        <br><br><p style="text-align: center;">¿No estás registrado?, Clic <a href="registro_cliente.jsp" style="color: #265ec9; font-weight: bold;">aquí</a> para registrarte.</p>
                    </div> 
                    <div class="col-lg-4"></div>
                </form>
            </div>
