...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">¡ SE LIMINÓ LA TARJETA SATISFACTORIAMENTE !
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="gestion_tarjetas">GESTIÓN DE TARJETAS</a>
                        </li>
                        <li class="active" style="color: #00bd32; font-size: 18px; font-weight: bold;">Puede seguir gestionando las tarjetas.</li>
                    </ol>
                </div>
            </div>
            <!-- /.row -->      
