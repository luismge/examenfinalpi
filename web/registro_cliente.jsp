<%-- 
    ...
    Created on : 28-nov-2015, 14:11:29
    Author     : JuanCarlos
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">INGRESE SUS DATOS PERSONALES:
                    </h1>
                    <ol class="breadcrumb">
            ...
            <div class="row">  
                <form method="POST" action="registro_cliente">
                    <div class="col-lg-6">
                        <p>Nombre:</p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <select class="form-control" name="tipo_tarjeta" required="">
                            <option value="1">Tarjeta Celeste</option>
                            <option value="2">Tarjeta Verde</option>
                            <option value="3">Tarjeta Morada</option>
                        </select>
                        <p>Correo:</p>
