...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">¡ ADMINISTRADOR DEL SISTEMA WEB !
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="ingreso_al_sistema_admin.jsp">INICIO</a>
                        </li>
                        <li class="active" style="color: #00bd32; font-size: 18px; font-weight: bold;">Ya puede gesionar la cartelera y las tarjetas.</li>
                    </ol>
                </div>
            </div>
            <!-- /.row -->      
