<%-- 
    Document   : cartelera
    Created on : 29-nov-2015, 20:10:18
    Author     : JuanCarlos
--%>

<%@page import="pe.edu.ulima.Funcion"%>
<%@page import="pe.edu.ulima.Pelicula"%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">NUESTRA CARTELERA:
                    </h1>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <% List<Funcion> listaFunciones = (List<Funcion>) request.getAttribute("listaFunciones"); %>
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="form-control" style="color: #ff3333; font-weight: bold; font-size: 13px; text-align: center">Detalles</a></td>
                            <td><a href="#" class="form-control" style="color: #ff3333; font-weight: bold; font-size: 13px; text-align: center">Comprar</a></td>
