...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">¡ BIENVENIDO A CINE PALTA !
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="obtener_peliculas">YA PUEDE VISUALIZAR LA CARTELERA</a>
                        </li>
                        <li class="active" style="color: #00bd32; font-size: 18px; font-weight: bold;">Ya puede visualizar la Cartelera y las Tarjetas de Cine Palta.</li>
                    </ol>
                </div>
            </div>
            <!-- /.row -->      
