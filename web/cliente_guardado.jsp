...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">¡ SE REGISTRO LA TARJETA SATISFACTORIAMENTE !
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="ingreso_al_sistema_admin.jsp">INICIO</a>
                        </li>
                        <li class="active" style="color: #00bd32; font-size: 18px; font-weight: bold;">Sus datos se guardaron satisfactoriamente, ya puede <a href="inicio_sesion.jsp">iniciar sesión</a>.</li>
                    </ol>
                </div>
            </div>
            <!-- /.row -->      
